...
function AlbumPage() {
    ...
    const handlePlaySong = (index:number)=>{
        ...
        // TODO: add play toggle fot the song in album
    }
                ...
                <div className="relative z-10">
                    <div className="flex p-6 gap-6 pb-8">
                        <img 
                            ...
                            className="w-[240px] h-[240px] shadow-lg rounded-lg"
                        />
                    ...
                    <div className="px-6 pb-4 flex items-center gap-6">
                        <Button
                            ...
                            size='icon'
                            className="w-14 h-14 rounded-full bg-zinc-500 hover:bg-zinc-300
                                                ...
                                                <div className="flex items-center justify-center">
                                                    {isCurrentSong && isPlaying?(
                                                        <div>
                                                            ...
                                                            <Pause className="h-4 w-4 text-zinc-400 hidden group-hover:block"/>
                                                        </div>
