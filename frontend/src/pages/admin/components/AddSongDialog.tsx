...
function AddSongDialog() {
    ...
    const audoInputRef = useRef<HTMLInputElement>(null)
    ...
    const handleSubmit = async()=>{
        ...
        try {
            if(!files.audio || !files.image){
                return toast.error("Please select both song and an image")
            }
            ...
            if(newSong.album && newSong.album!=='none'){
                formDate.append('albumId',newSong.album)
            }
            formDate.append('audioFile',files.audio)
            formDate.append('imageFile',files.image)

            await axiosInstance.post('/admin/songs',formDate,{
                headers:{
            ...
            <div className="space-y-4 py-4">
                ...
                <div className='space-y-2'>
                    ...
                    <div className='flex items-center gap-2'>
                        <Button variant='outline' onClick={() => audoInputRef.current?.click()} className='w-full'>
